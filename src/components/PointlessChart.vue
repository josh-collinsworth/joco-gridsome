...
export default {
	data: () => ({
		chartItems: [
			{ name: "Vue", x: 81, y: 85, color: '#4fc08d' },
			...
			{ name: "WordPress", x: 86, y: 59, color: '#21759b' },
			{ name: "React", x: 56, y: 57, color: '#81d9f7' },
			...
			{ name: "Accessibility", x: 60, y: 63 },
			{ name: "RegEx", x: 73, y: 50 },
			{ name: "Performance", x: 78, y: 54 },
