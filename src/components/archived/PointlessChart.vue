...
export default {
	data: () => ({
		chartItems: [
			{ name: "Vue", x: 86, y: 86, color: '#4fc08d' },
			{ name: "Svelte", x: 64, y: 93, color: '#ff3e00' },
			{ name: "HTML", x: 84, y: 40, color: '#d45632' },
			{ name: "CSS", x: 90, y: 91, color: '#264de4' },
			{ name: "JavaScript", x: 86, y:73, color: '#f0db4f' },
			{ name: "WordPress", x: 86, y: 65, color: '#21759b' },
			{ name: "React", x: 56, y: 58, color: '#81d9f7' },
			{ name: "PHP", x: 43, y: 36, color: '#777bb3' },
			{ name: "Nuxt", x: 72, y: 85, color: '#374759' },
			{ name: "Gridsome", x: 69, y: 79, color: '00a672' },
			{ name: "Ruby", x: 39, y: 44, color: '#cc342d' },
			{ name: "Rails", x: 50, y: 28, color: '#cc0000' },
			...
			{ name: "Accessibility", x: 60, y: 64 },
			{ name: "RegEx", x: 73, y: 50 },
			{ name: "Performance", x: 80, y: 54 },
