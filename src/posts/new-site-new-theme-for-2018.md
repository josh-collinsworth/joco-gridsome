...
[![A list of Sass variables used for colors, breakpoints, fonts and Flexbox settings](../assets/images/post_images/sass-variables.png)](/assets/images/post_images/sass-variables.png)
...
[![Custom fields that allow for a width and height property to use in the image grid](../assets/images/post_images/acf-fields-1-1024x797.png)](/assets/images/post_images/acf-fields-1.png)

The width and height have max values, and a Sass loop (and a media query) sets CSS for those values with classes:

## [![A Sass @for loop to set classes for each possible width and height, and add CSS accordingly.](../assets/images/post_images/sass-grid.png)](/assets/images/post_images/sass-grid.png)New Logo
...
![](../assets/images/post_images/Full-Logo-2018.svg)
