...
[![A list of Sass variables used for colors, breakpoints, fonts and Flexbox settings](https://joshcollinsworth.com/wp-content/uploads/2017/12/sass-variables.png)](https://joshcollinsworth.com/wp-content/uploads/2017/12/sass-variables.png)
...
I also took this opportunity to use CSS grid on a project for the first time—specifically, on the [design](https://joshcollinsworth.com/design/) page. It turns out, CSS grid mixes really well with [Advanced Custom Fields](https://www.advancedcustomfields.com/), particularly the Pro Repeater field. I set up fields for images, height and width, to control the size of images in the grid:

[![Custom fields that allow for a width and height property to use in the image grid](https://joshcollinsworth.com/wp-content/uploads/2018/01/acf-fields-1-1024x797.png)](https://joshcollinsworth.com/wp-content/uploads/2018/01/acf-fields-1.png)

The width and height have max values, and a Sass loop (and a media query) sets CSS for those values with classes:

## [![A Sass @for loop to set classes for each possible width and height, and add CSS accordingly.](https://joshcollinsworth.com/wp-content/uploads/2018/01/sass-grid.png)](https://joshcollinsworth.com/wp-content/uploads/2018/01/sass-grid.png)New Logo
...
![](https://joshcollinsworth.com/wp-content/uploads/2017/12/Full-Logo-2018-1.svg)
